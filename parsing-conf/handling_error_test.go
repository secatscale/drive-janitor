...
func TestFillingStruct(t *testing.T) {
	...
	t.Run("TestConfig1", func(t *testing.T) {
		...
		assertCorrectyamlstring(t, "detection1", rules[0].Detection.Detections[0].Name)
		assertCorrectyamlstring(t, "image/png", rules[0].Detection.Detections[0].MimeType)
	...
	t.Run("TestConfig2", func(t *testing.T) {
		...
		assertCorrectyamlstring(t, "detection2", rules[0].Detection.Detections[0].Name)
		assertCorrectyamlstring(t, "application/pdf", rules[0].Detection.Detections[0].MimeType)
		assertCorrectyamlstring(t, "detection3", rules[0].Detection.Detections[1].Name)
		assertCorrectyamlstring(t, "text/plain", rules[0].Detection.Detections[1].MimeType)
